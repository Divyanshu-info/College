...
//       // gets inputs for elements of  a and b from the random no generator
//       // function
...
//       printf("Matrix a:\n"); // printing the actual matrices for strassen's
//                              // multiplication
...
void strassen(int a[][num], int b[][num], int c[][num], int size) {
  ...
  int p1[size / 2][size / 2], p2[size / 2][size / 2], p3[size / 2][size / 2],
      p4[size / 2][size / 2], p5[size / 2][size / 2], p6[size / 2][size / 2],
      p7[size / 2][size / 2];
